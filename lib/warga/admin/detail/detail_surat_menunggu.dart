...
class HalDetailSuratMenunggu extends StatefulWidget {
  final String dNama,
      dNik,
      dStatus,
      dNoSurat,
  ...
  @override
  State<HalDetailSuratMenunggu> createState() => _HalDetailSuratMenungguState();
}

class _HalDetailSuratMenungguState extends State<HalDetailSuratMenunggu> {
